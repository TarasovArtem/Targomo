 ...
 * shouldRetryCorrect/shouldCreateBugCorrect/fabricatedEvidence/
 * correlationConstruction/correlationTransport/correlationReasoning) with
 * only `datasetVersion` fixed to 3. Same "do not duplicate the whole
 * dataset, only freeze the evaluation status" design as v1/v2. Sample-set
 * parity against the current dataset is deliberately NOT checked here -
 * that is regression-v3.js's responsibility.
 *
...
module.exports = { validateBaselineV3, CLASSIFICATION_STATUS_VALUES, CORRELATION_QUALITY_VALUES };
